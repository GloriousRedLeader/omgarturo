...
from Scripts.omgarturo.src.fm_core.core_attack import run_mage_loop

# This one is configured for: Insane UO Pure Necro
# Its the same as the other one just without animate dead and summon familiar.
# This has its uses believe me. Dont want to body block with a million undead
# in tiny hallways.
