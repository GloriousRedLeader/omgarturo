...
# Main code
run_mage_loop(loopName='Mage Bard Heal', friendSelectMethod=0, friendNames=['omg arturo', 'omg arthur', 'badhorsey', 'omg art', 'omg artus', 'omg artie', 'goodhorsey'], range=10, useArcaneEmpowerment=1, mainNukeSpell=0, mainNukeDelayMs=100, mainAoeSpell=0, mainAoeDelayMs=100, aoeMinMobCount=3, aoeMaxRange=8, useStrangle=0, strangleDelayMs=60000, useCorpseSkin=0, corpseSkinDelayMs=60000, useEvilOmen=0, evilOmenDelayMs=20000, useBloodOath=0, bloodOathDelayMs=30000, useCurse=0, curseDelayMs=60000, usePoison=0, poisonDelayMs=30000, usePoisonField=0, poisonFieldDelayMs=10000, useFireField=0, fireFieldDelayMs=10000, useDeathRay=0, useWordOfDeath=0, useWildfire=0, usePainSpike=0, useAnimateDead=0, animateDeadDelayMs=60000, useSummonFamiliar=0, useForm=0, useCure=1, useGreaterHeal=1, useSpiritSpeak=0, useConduit=0, conduitDelayMs=15000, useMeditation=1, healThreshold=0.7, useCloakOfGraveMists=0, useGiftOfRenewal=1, useGiftOfLife=1, useAttuneWeapon=1, useBardAbility=0, bardAbilityDelayMs=8000, useBardSongs=2, useProtection=0, useHonor=0, minGold=45000, latencyMs=200)
