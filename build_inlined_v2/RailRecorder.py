...
railcoords = []
moblist = [39321]
layers = ['RightHand', 'LeftHand', 'Shoes', 'Pants', 'Shirt', 'Head', 'Gloves', 'Ring', 'Neck', 'Waist', 'InnerTorso', 'Bracelet', 'MiddleTorso', 'Arms', 'Cloak', 'OuterTorso', 'OuterLegs', 'InnerLegs', 'Talisman']
