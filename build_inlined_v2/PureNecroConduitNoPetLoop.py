...
# Main code
run_mage_loop(loopName='Conduit Necro (no pet)', friendSelectMethod=0, friendNames=[], range=11, useArcaneEmpowerment=0, mainNukeSpell=1, mainNukeDelayMs=100, mainAoeSpell=0, mainAoeDelayMs=100, aoeMinMobCount=3, aoeMaxRange=8, useStrangle=1, strangleDelayMs=25000, useCorpseSkin=1, corpseSkinDelayMs=30000, useEvilOmen=2, evilOmenDelayMs=20000, useBloodOath=0, bloodOathDelayMs=30000, useCurse=0, curseDelayMs=60000, usePoison=0, poisonDelayMs=30000, usePoisonField=0, poisonFieldDelayMs=10000, useFireField=0, fireFieldDelayMs=10000, useDeathRay=0, useWordOfDeath=0, useWildfire=0, usePainSpike=1, useAnimateDead=0, animateDeadDelayMs=25000, useSummonFamiliar=0, useForm=2, useCure=0, useGreaterHeal=0, useSpiritSpeak=1, useConduit=1, conduitDelayMs=15000, useMeditation=0, healThreshold=0.7, useCloakOfGraveMists=1, useGiftOfRenewal=0, useGiftOfLife=0, useAttuneWeapon=0, useBardAbility=0, bardAbilityDelayMs=10000, useProtection=0, useHonor=0, minGold=45000, latencyMs=200)
