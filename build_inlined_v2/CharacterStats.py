...
class CharacterStats(Forms.Form):
    ...
    def getStatsFromItems(self):
        ...
        stats = [{'name': 'Strength Bonus', 'value': 0, 'max': 150, 'group_name': 'Stats', 'description': 'Increases your Strength Stat by the number of points on the item'}, {'name': 'Intelligence Bonus', 'value': 0, 'max': 150, 'group_name': 'Stats', 'description': 'Increases your Intelligence Stat by the number of points on the item.'}, {'name': 'Dexterity Bonus', 'value': 0, 'max': 150, 'group_name': 'Stats', 'description': 'Increases your Dexterity Stat by the number of points on the item'}, {'name': 'Stamina Increase', 'value': 0, 'max': 0, 'group_name': 'Stats', 'description': 'Increases your maximum stamina by the number of points on the item.'}, {'name': 'Stamina Regeneration', 'value': 0, 'max': 24, 'max_uoex': 40, 'group_name': 'Stats', 'description': 'Increases the rate at which you regain stamina. (0.1 point per second per point of SR.)\n\nUOEX: All regens have a diminshing return rate after 35-40 (see wiki). This is with 120 Focus'}, {'name': 'Hit Point Increase', 'value': 0, 'max': 25, 'group_name': 'Stats', 'description': 'Increases your maximum hit points by the number of points on the item.'}, {'name': 'Hit Point Regeneration', 'value': 0, 'max': 18, 'max_uoex': 55, 'group_name': 'Stats', 'description': 'Increases the rate at which you regain hit points. (0.1 hit point per second per hpr point).\n\nUOEX:  All regens have a diminshing return rate after 50-55 (see wiki).'}, {'name': 'Mana Increase', 'value': 0, 'max': 0, 'group_name': 'Stats', 'description': 'Increases your maximum mana by the number of points on the item.'}, {'name': 'Mana Regeneration', 'value': 0, 'max': 0, 'max_uoex': 35, 'group_name': 'Stats', 'description': 'Increases the rate at which you regain mana, subject to diminishing returns. Can be crafted on Spellbooks, maximum intensity of 1.\n\nUOEX: All regens have a diminshing return rate after 30-35 (see wiki). This is with 120 Meditation and 120 Focus'}, {'name': 'Hit Chance Increase', 'value': 0, 'max': 45, 'max_uoex': 70, 'group_name': 'Melee', 'description': 'Increases your chance to hit your opponents. If you before Hit Chance Increase is applied have 50% chance to hit, with 20% Hit Chance Increase you will have 60% chance to hit.\n\nUOEX: 70% HCI nullifies any effect from HLA.'}, {'name': 'Swing Speed Increase', 'value': 0, 'max': 60, 'group_name': 'Melee', 'description': 'Increases the base speed at which you swing your weapon. (Maximum swing speed = 1 swing per 1.25 seconds) Affects hit leech properties  (see footnote)\n\nUOEX: 60% cap from gear. Stamina affects swing speed, not dexterity. With 237 stamina, you will swing all weapons at full speed.'}, {'name': 'Damage Increase', 'value': 0, 'max': 100, 'group_name': 'Melee', 'description': 'Increases the base damage you inflict with your weapon.  Can be removed from exceptional crafted items by use of Whetstone of Enervation\n\nUOEX:100% Cap from equipment, uncapped otherwise.'}, {'name': 'Defense Chance Increase', 'value': 0, 'max': 45, 'max_uoex': 80, 'group_name': 'Melee', 'description': 'Increases your chance to dodge blows. If before DCI is applied you have 50% chance to dodge, with 20% DCI you will have 60% chance to dodge.\n\nUOEX:    Divine Fury lowers DCI by 10%. You need 55% to effectively cap this. 80% nullifies any effect from HLA, combined with the -10% from Divine Fury.'}, {'name': 'Reflect Physical Damage', 'value': 0, 'max': 250, 'max_uoex': 0, 'group_name': 'Melee', 'description': 'Reflect Physical Damage will reflect a percentage of any kinetic physical damage that is inflicted on you back onto the one who inflicted it.\n\nUOEX: Awesome to have if you can take the hits'}, {'name': 'Spell Damage Increase', 'value': 0, 'max': 250, 'max_uoex': 0, 'group_name': 'Magic', 'description': 'This property increases the damage for most magical attacks that are casted. While the property is normally caped at 20% in PvP, the cap can be further increased to 25% for focused templates.\nFocus templates have no more than 30 modified skill points in mor than one primary skill such as magery, necromancy, mysticism, ninjitsu, bushido, animal taming, musicianship, chivalry or spellweaving.\nAlso no more than 30 modified skill points in the associated secondary skill such as evaluate intelligence, spirit speaking, focus, imbuing.\nExample: magery/eval/inscrip/wrestle is a ‘pure’ mage and will have 25% sdi, adding another of the primary skills listed here, or a secondary skill not \nassociated with your chosen primary, at above 30 skill points reduces the sdi cap back to 20%. Spell damage increase in PvM is 250%.\nThis property is most commonly found on accessories and spellbooks\n\nUOEX: This uncapped for Player Vs. Monster(PvM), but capped at 15% for Player Vs. Player (PvP)'}, {'name': 'Faster Cast Recovery', 'value': 0, 'max': 6, 'group_name': 'Magic', 'description': "Shortens waiting time between casting spells.\n\nUOEX: Unsure if cap on wep is 6, but you don't need more."}, {'name': 'Faster Casting', 'value': 0, 'max': 4, 'group_name': 'Magic', 'description': 'Decreases the time required to cast  spells by 0.25 seconds per point. Capped at 2 for magery, necromancy & mysticism and 4 for  chivalry (if magery is below 70 skill) and spellweaving .\n\nUOEX: The spell Protection lowers FC by 2. You cannot go over the cap to compensate.'}, {'name': 'Lower Mana Cost', 'value': 0, 'max': 40, 'group_name': 'Magic', 'description': "Lowers the amount of mana needed to cast a spell or use a special move.\n\nUOEX:    GoC Chest/Sleeves/Boots gives 20% LMC. Follower's Sash give 8%."}, {'name': 'Lower Reagent Cost', 'value': 0, 'max': 100, 'group_name': 'Magic', 'description': 'Lowers the amount of reagents needed to cast spells, both magery and necromancy. 100% negates the need to carry reagents at all. Tithing points, though unused, are required to be available to cast Chivalry spells.\n\nUOEX: Saves you money on regs/tithing.'}, {'name': 'Enhance Potions', 'value': 0, 'max': 50, 'group_name': 'Magic', 'description': 'Increases the effects of potions when they are used. Poison and nightsight potions are excluded.'}, {'name': 'Physical Resist', 'value': 0, 'max': 70, 'group_name': 'Resistances', 'description': 'Get to 70'}, {'name': 'Fire Resist', 'value': 0, 'max': 70, 'group_name': 'Resistances', 'description': 'Get to 70'}, {'name': 'Cold Resist', 'value': 0, 'max': 70, 'group_name': 'Resistances', 'description': 'Get to 70'}, {'name': 'Poison Resist', 'value': 0, 'max': 70, 'group_name': 'Resistances', 'description': 'Get to 70'}, {'name': 'Energy Resist', 'value': 0, 'max': 70, 'group_name': 'Resistances', 'description': 'Get to 70'}, {'name': 'Hit Life Leech', 'value': 0, 'max': 0, 'group_name': 'Weapon Hits', 'description': 'On every successful hit, converts a percentage of the damage inflicted by the attack into hit points for the wielder.\n(If you hit your target for 50 damage with a 60% Hit Life Leech weapon, you have a chance of healing between 0 (50 * 30% * 1% = 0.15) and 9 (50 * 30% * 60%) hit points.).'}, {'name': 'Hit Stamina Leech', 'value': 0, 'max': 0, 'group_name': 'Weapon Hits', 'description': 'Has a percentage chance on each hit to convert 100% of the damage inflicted on the target into stamina for the wielder.\n(If you hit your target for 50 damage, you have a chance of regaining 50 stamina).'}, {'name': 'Hit Mana Leech', 'value': 0, 'max': 0, 'group_name': 'Weapon Hits', 'description': 'On every successful hit, converts a percentage of the damage inflicted by the attack into mana points for the wielder.\n(If you hit your target for 50 damage with a 60% Hit Mana Leech weapon, you have a chance of recovering between 0 (50 * 40% * 1% = 0.2) and 12 (50 * 40% * 60%) mana.)'}, {'name': 'Hit Lower Attack', 'value': 0, 'max': 0, 'group_name': 'Weapon Hits', 'description': 'Has a percentage chance on each hit to lower the hit chance of the target (HCI -25). Approximate duration, 5-10 seconds.\nThe effect does not stack with itself,  percentage hit chance from items is multiplied, not added. example item 1 has 50% hla, item 2 has 30% hla, total hla = 65%'}, {'name': 'Hit Lower Defense', 'value': 0, 'max': 0, 'group_name': 'Weapon Hits', 'description': 'Has a percentage chance on each hit to lower the defensive capabilities of the target(DCI -25). Approximate duration, 5-10 seconds.\nThe effect does not stack with itself,  percentage hit chance from items is multiplied, not added. example item 1 has 50% hld, item 2 has 30% hld, total hld = 65%  In pvp reduces 35% of the target’s maximum DCI.'}, {'name': 'Hit Magic Arrow', 'value': 0, 'max': 0, 'group_name': 'Weapon Hits', 'description': 'Has a percentage chance on each hit to cast the magery spell magic arrow on the target.'}, {'name': 'Hit Harm', 'value': 0, 'max': 0, 'group_name': 'Weapon Hits', 'description': 'Has a percentage chance on each hit to cast the magery spell harm on the target.'}, {'name': 'Hit Fireball', 'value': 0, 'max': 0, 'group_name': 'Weapon Hits', 'description': 'Has a percentage chance on each hit to cast the magery spell fireball on the target.'}, {'name': 'Hit Lightning', 'value': 0, 'max': 0, 'group_name': 'Weapon Hits', 'description': 'Has a percentage chance on each hit to cast the magery spell lightning on the target.'}, {'name': 'Hit Dispel', 'value': 0, 'max': 0, 'group_name': 'Weapon Hits', 'description': 'Has a percentage chance on each hit, based on the wielder’s Tactics skill,  to cast the magery spell dispel on any summoned creature.'}, {'name': 'Luck', 'value': 0, 'max': 0, 'max_uoex': 7200, 'group_name': 'Misc', 'description': 'Potentially increases monster loot in 3 ways; a)number of items; b)number of properties; c)intensity of properties.'}]
        ...
        resistMap = {'Physical Resist': 1, 'Fire Resist': 2, 'Cold Resist': 3, 'Poison Resist': 4, 'Energy Resist': 5}
