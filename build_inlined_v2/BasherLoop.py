...
# Main code
run_dex_loop(loopName='Bashmaster', specialAbilityType=2, useShieldBash=1, useConsecrateWeapon=1, useCurseWeapon=0, useDivineFury=0, useEnemyOfOne=0, useRemoveCurse=1, useCleanseByFire=0, useHonor=0, attackRange=6, minGold=30000, latencyMs=200)
