...
# Main code
run_dex_loop(loopName='Basher (secondary)', specialAbilityType=2, useShieldBash=1, useConsecrateWeapon=1, useCurseWeapon=0, useDivineFury=0, useEnemyOfOne=0, useRemoveCurse=1, useCleanseByFire=0, useHonor=0, attackRange=6, useBandagesOnSelf=1, healThreshold=0.95, minGold=35000, latencyMs=200)
