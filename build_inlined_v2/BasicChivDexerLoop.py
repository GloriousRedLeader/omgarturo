...
# Main code
run_dex_loop(loopName='Dex Loop', specialAbilityType=1, useShieldBash=0, useConsecrateWeapon=1, useCurseWeapon=0, useDivineFury=0, useEnemyOfOne=0, useRemoveCurse=0, useCleanseByFire=0, attackRange=6, minGold=0, latencyMs=200)
