...
# Main code
run_fishing_loop(fishRange=4, moveTiles=2, fishDelayMs=9000, fishHandling=1, fishToKeep=None, cutToolItemId=DAGGER_STATIC_ID, useCorpseScanner=False, corpseScannerMoveCommandDelayMs=650, corpseScannerPauseDelayMs=2000, corpseNames=['a deep sea serpents corpse', 'a sea serpents corpse'])
