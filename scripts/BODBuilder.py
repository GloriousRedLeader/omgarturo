...
# CAT_CARPENTRY_ARMOR (from core_crafting.py)
...
# HUE_ALCHEMY (from core_items.py)
HUE_ALCHEMY = 0x09c9

# HUE_BLACKSMITHY (from core_items.py)
HUE_BLACKSMITHY = 0x044e

# HUE_CARPENTRY (from core_items.py)
HUE_CARPENTRY = 0x05e8

# HUE_INSCRIPTION (from core_items.py)
HUE_INSCRIPTION = 0x0a26

# HUE_TAILORING (from core_items.py)
HUE_TAILORING = 0x0483

# HUE_TINKERING (from core_items.py)
...
# LARGE_BOD_GUMP_ID (from core_crafting.py)
...
# PROD_ID_LARGE_BULK_ORDER (from core_crafting.py)
PROD_ID_LARGE_BULK_ORDER = 1060655

# PROP_ID_AMOUNT_TO_MAKE (from core_crafting.py)
PROP_ID_AMOUNT_TO_MAKE = 1060656

# PROP_ID_BOD_EXCEPTIONAL (from core_crafting.py)
PROP_ID_BOD_EXCEPTIONAL = 1045141

# PROP_ID_ITEM_TEXT (from core_crafting.py)
PROP_ID_ITEM_TEXT = 1060658

# PROP_ID_SMALL_BULK_ORDER (from core_crafting.py)
...
# SMALL_BOD_GUMP_ID (from core_crafting.py)
...
# SPECIAL_PROP_MATERIAL_MAP (from core_crafting.py)
