...
# BOW_GRAPHIC_ID (from core_items.py)
BOW_GRAPHIC_ID = 0x13B2

# CARRONADE_GRAPHIC_ID (from core_items.py)
CARRONADE_GRAPHIC_ID = 0x421D

# DRYDOCK_SHIP_GRAPHIC_ID (from core_items.py)
DRYDOCK_SHIP_GRAPHIC_ID = 0x14F4

# GIANT_SERPENT_MOBILE_ID (from core_mobiles.py)
GIANT_SERPENT_MOBILE_ID = 0x0015

# HUNTING_PERMIT_GRAPHIC_ID (from core_items.py)
HUNTING_PERMIT_GRAPHIC_ID = 0x14F0

# PAINTS_AND_A_BRUSH_STATIC_ID (from core_items.py)
PAINTS_AND_A_BRUSH_STATIC_ID = 0x0FC1

# RAMROD_STATIC_ID (from core_items.py)
RAMROD_STATIC_ID = 0x4246

# RARE_SERPENT_EGG_STATIC_ID (from core_items.py)
RARE_SERPENT_EGG_STATIC_ID = 0x41BF

# SERPENT_NEST_STATIC_ID (from core_items.py)
SERPENT_NEST_STATIC_ID = 0x2233

# SILVER_SERPENT_MOBILE_ID (from core_mobiles.py)
SILVER_SERPENT_MOBILE_ID = 0x005C

# SNAKE_CHARMER_FLUTE_STATIC_ID (from core_items.py)
...
# CANNON_GRAPHIC_IDS (from core_items.py)
