...
# ---- AXE_STATIC_IDS (binding from core_items.py)
AXE_STATIC_IDS = [0x0F49, 0x0F47]

# ===== Inlined block from core_items.py =====
# ---- LOG_STATIC_IDS (binding from core_items.py)
LOG_STATIC_IDS = [0x1BDD]

# ===== Inlined block from core_items.py =====
# ---- TREE_STATIC_IDS (binding from core_items.py)
...
# ===== Inlined block from core_items.py =====
# ---- DAGGER_STATIC_IDS (binding from core_items.py)
DAGGER_STATIC_IDS = [0x0F52]

# ===== Inlined block from core_items.py =====
# ---- BOARD_STATIC_IDS (binding from core_items.py)
BOARD_STATIC_IDS = [0x1BD7]

# ===== Inlined block from core_items.py =====
# ---- MINER_TOOLS_STATIC_IDS (binding from core_items.py)
MINER_TOOLS_STATIC_IDS = [0x0F39, 0x0E86]

# ===== Inlined block from core_items.py =====
# ---- ORE_STATIC_IDS (binding from core_items.py)
ORE_STATIC_IDS = [
    0x19B7, 
    0x19BA, 
    0x19B8, 
...
# ===== Inlined block from core_items.py =====
# ---- INGOT_STATIC_IDS (binding from core_items.py)
INGOT_STATIC_IDS = [0x1BF2]

# ===== Inlined block from core_items.py =====
# ---- STONE_STATIC_IDS (binding from core_items.py)
STONE_STATIC_IDS = [0x1779]

# ===== Inlined block from core_items.py =====
# ---- SAND_STATIC_IDS (binding from core_items.py)
