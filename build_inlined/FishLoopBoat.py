...
# ---- FISH_STATIC_IDS (binding from core_items.py)
FISH_STATIC_IDS = [
    0x4302, # Demon Trout
    0x4303, # Bonito
    0x4306, # Cape cod
...
# ===== Inlined block from core_items.py =====
# ---- DAGGER_STATIC_ID (binding from core_items.py)
DAGGER_STATIC_ID = 0x0F52

# ===== Inlined block from core_items.py =====
# ---- HARVESTERS_BLADE_STATIC_ID (binding from core_items.py)
HARVESTERS_BLADE_STATIC_ID = 0x2D20

# ===== Inlined block from core_items.py =====
# ---- BUTCHERS_WAR_CLEAVER_STATIC_ID (binding from core_items.py)
