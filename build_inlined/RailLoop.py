...
# ===== Inlined block from core_routes.py =====
# ---- new_haven_noob_dungeon (binding from core_routes.py)
...
# ===== Inlined block from core_routes.py =====
# ---- new_haven_skeleton_town (binding from core_routes.py)
...
# ===== Inlined block from core_routes.py =====
# ---- deceipt_1_full (binding from core_routes.py)
...
# ===== Inlined block from core_routes.py =====
# ---- deceipt_2_full (binding from core_routes.py)
...
# ===== Inlined block from core_routes.py =====
# ---- tortuga_champ_spawn (binding from core_routes.py)
tortuga_champ_spawn = [[5724, 3991], [5718, 3997], [5720, 3990], [5725, 3986], [5731, 3988], [5731, 3994], [5725, 3995]]

# ===== Inlined block from core_routes.py =====
# ---- vermin_horde_champ_middle (binding from core_routes.py)
...
# ===== Inlined block from core_routes.py =====
# ---- vermin_horde_champ_top (binding from core_routes.py)
...
# ===== Inlined block from core_routes.py =====
# ---- hythloth_2 (binding from core_routes.py)
...
# ===== Inlined block from core_routes.py =====
# ---- hythloth_3 (binding from core_routes.py)
...
# ===== Inlined block from core_routes.py =====
# ---- hythloth_4 (binding from core_routes.py)
hythloth_4 = []
