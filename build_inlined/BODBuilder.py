...
# ---- RESOURCE_HUE_DEFAULT (binding from core_items.py)
RESOURCE_HUE_DEFAULT = 0x0000

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_DULL_COPPER (binding from core_items.py)
RESOURCE_HUE_DULL_COPPER = 0x0973

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_SHADOW_IRON (binding from core_items.py)
RESOURCE_HUE_SHADOW_IRON = 0x0966

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_COPPER (binding from core_items.py)
RESOURCE_HUE_COPPER = 0x096d

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_BRONZE (binding from core_items.py)
RESOURCE_HUE_BRONZE = 0x0972

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_GOLD (binding from core_items.py)
RESOURCE_HUE_GOLD = 0x08a5

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_AGAPITE (binding from core_items.py)
RESOURCE_HUE_AGAPITE = 0x0979

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_VERITE (binding from core_items.py)
RESOURCE_HUE_VERITE = 0x089f

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_VALORITE (binding from core_items.py)
RESOURCE_HUE_VALORITE = 0x08ab

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_BARBED (binding from core_items.py)
RESOURCE_HUE_BARBED = 0x0851

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_SPINED (binding from core_items.py)
RESOURCE_HUE_SPINED = 0x08ac

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_HORNED (binding from core_items.py)
RESOURCE_HUE_HORNED = 0x0845

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_OAK (binding from core_items.py)
RESOURCE_HUE_OAK = 0x07da

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_ASH (binding from core_items.py)
RESOURCE_HUE_ASH = 0x04a7

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_YEW (binding from core_items.py)
RESOURCE_HUE_YEW = 0x04a8

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_HEARTWOOD (binding from core_items.py)
RESOURCE_HUE_HEARTWOOD = 0x04a9

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_BLOODWOOD (binding from core_items.py)
RESOURCE_HUE_BLOODWOOD = 0x04aa

# ===== Inlined block from core_items.py =====
# ---- RESOURCE_HUE_FROSTWOOD (binding from core_items.py)
...
# ---- parse_large_bod (from core_crafting.py)
